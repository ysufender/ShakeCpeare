...
Ever yearned of those times of verbose programming languages, where they were
...
Haha! Try to compile the "shakecpeare.c" that's in this repo then,
it is not that complex but complex enough to prove that ShakeCpeare is
superior to plain C.
